...
namespace _Project.TasksAndDialogues.Tasks.Scripts.DailyWeekly.Tasks
{
    public class DestroyEnemiesTask : Task
    {
        ...
        public DestroyEnemiesTask(TaskDataReachValueUlong taskData, MainCharacterData characterData)
        {
        ...
        public DestroyEnemiesTask(TaskDataReachValueUlong taskData, MainCharacterData characterData, TaskSaveData taskSaveData)
        {
            TaskType = taskData.taskType;
