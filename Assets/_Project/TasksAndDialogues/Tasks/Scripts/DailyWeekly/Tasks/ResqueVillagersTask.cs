...
{
    public class ResqueVillagersTask : Task
    {
        private TaskDataReachValueUlong _taskData;
        
        public ResqueVillagersTask(TaskDataReachValueUlong taskData, MainCharacterData characterData)
        {
        ...
        public ResqueVillagersTask(TaskDataReachValueUlong taskData, MainCharacterData characterData, TaskSaveData taskSaveData)
        {
            TaskType = taskData.taskType;
